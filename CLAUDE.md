...
transiciones es `.agents/kernel/orchestration-kernel.mjs`, construido mediante
la única composición productiva `.agents/kernel/composition.mjs`; los roles
consumen `WorkEnvelope` y devuelven `RoleReport` sin mutar el estado. El archivo
