...
`.agents/kernel/composition.mjs` como única composición productiva de
...
Usar `inspect` para lectura y `apply` para toda transición. Este archivo es solo
un adapter: no reinterpretar ni duplicar las políticas canónicas.
